...
// Historical: the original implementation used 'arm_math.h', which does
// not exist for x86. The SDFT implementation is portable float math, so
// simulator targets may opt back in with SIMULATOR_DYN_NOTCH.
